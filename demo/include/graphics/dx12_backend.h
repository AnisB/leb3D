...
#pragma region Copy
        ...
        void copy_render_texture(CommandBuffer copy_buffer_into_texture_mips, RenderTexture inputTexture, RenderTexture outputTexture);
...
#pragma region Graphics Pipeline
        ...
        void dispatch_mesh(CommandBuffer commandBuffer, GraphicsPipeline graphicsPipeline, uint32_t sizeX, uint32_t sizeY, uint32_t sizeZ);
#pragma endregion
...
#pragma endregion
    ...
    namespace profiling_scope
    {
        ...
        uint64_t get_duration_us(ProfilingScope profilingScope, CommandQueue cmdQ);
    }
