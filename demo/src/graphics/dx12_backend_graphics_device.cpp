...
namespace d3d12
{
    namespace device
    {
        ...
        GraphicsDevice create_graphics_device(DevicePickStrategy pickStrategy, uint32_t id)
        {
            ...
            // Validate
            assert_msg(adapter != nullptr, "D3D12: Failed to find suitable adapter.");
            ...
            HRESULT result = D3D12CreateDevice(adapter, D3D_FEATURE_LEVEL_12_2, IID_PPV_ARGS(&dx12_device->device));
