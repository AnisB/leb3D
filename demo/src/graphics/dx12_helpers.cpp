        ...
        for (uint32_t i = 0; i < shaderDesc.BoundResources; ++i)
        {
            ...
            switch (bindDesc.Type)
            {
                case D3D_SIT_CBUFFER:
                    cbvCount = max(bindDesc.BindPoint + 1, cbvCount);
                    bindType = 0;
                    break;
                ...
                case D3D_SIT_RTACCELERATIONSTRUCTURE:
                    srvCount = max(bindDesc.BindPoint + 1, srvCount);
                    bindType = 1;
                    break;
                ...
                case D3D_SIT_UAV_FEEDBACKTEXTURE:
                    uavCount = max(bindDesc.BindPoint + 1, uavCount);
                    bindType = 2;
                    break;
                case D3D_SIT_SAMPLER:
                    samplerCount = max(bindDesc.BindPoint + 1, samplerCount);
                    bindType = 3;
                    break;
            }
